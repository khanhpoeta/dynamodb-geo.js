...
import { DeletePointInput, GetPointInput, PutPointInput, QueryRadiusInput, QueryRectangleInput, UpdatePointInput } from './types';
/**
 * <p>
...
export declare class GeoDataManager {
     ...
     */
    queryRectangle(queryRectangleInput: QueryRectangleInput): Promise<Record<string, any>[]>;
    /**
     * <p>
